...
- Task: 09/T3
- Issue: none
- Touches: src/features/auth/, src/features/friends/, src/app/routes/
- Supersedes: none
- Acked: none
...
`docs/phases/09-auth-and-shell/PLAN.md`에서 09/T3의 Done when·Acceptance Criteria를 확인하고 HANDOFF의 Goal·Work In Progress를 쓴 뒤 시작한다.
