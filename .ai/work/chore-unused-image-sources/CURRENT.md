# Current State — chore-unused-image-sources

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-unused-image-sources
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-unused-image-sources
- Task: -/-
- Issue: none
- Touches: src/ui/assets/og.png,src/ui/assets/elephant.png
- Supersedes: none
...
- 1. 참조 없는 `src/ui/assets/og.png`·`elephant.png` 삭제 (commit 077762e)
