# Current State — spec-dating-requests-api

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: spec-dating-requests-api
- Owner: gn00py48@gmail.com
- Branch: ws/spec-dating-requests-api
- Task: -/-
- Issue: none
...
- openapi `/dating/requests` 5개 경로 + `DatingRequest`·`DatingRequestStatus` 스키마 (WKS-BE api-spec §11, dev 8827766) ✓
- redocly lint — 새 문제 0(기존 1 error·5 warn 그대로) · BE 갭 HANDOFF 기록 ✓
- PR ←
...
- `docs/api/openapi.yaml` paths `/dating/recommendations` 뒤 · components `DatingCandidate` 앞

## Next Action

PR 리뷰(@hairyung2002 — docs/api Owner) 뒤 병합 → 11/T2 스트림 open.
