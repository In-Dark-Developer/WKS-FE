# Current State — chore-logout-clears-browser-result

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-logout-clears-browser-result
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-logout-clears-browser-result
- Task: -/-
- Issue: none
- Touches: src/api/auth.ts,src/api/auth.test.ts,docs/decisions/
- Supersedes: none
...
chore: logout-clears-browser-result
...
- [x] 로그아웃 성공 시 `clearSession()` + ADR (7371529)
...
- `docs/decisions/ADR-20260927-logout-clears-browser-result.md`
