# Current State — spec-cookie-auth-contract

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: spec-cookie-auth-contract
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/spec-cookie-auth-contract
- Task: -/-
- Issue: none
- Touches: docs/api/openapi.yaml,docs/phases/09-auth-and-shell/PLAN.md,.ai/team/announcements/,.ai/team/README.md
- Supersedes: none
...
- 1. openapi 쿠키 계약 · 2. PLAN 09 T2 Owner·메모 · 3. 공지 2026-09-25-cookie-auth-contract (완료)
...
- WKS-BE `docs/api-spec.md` §9 (dev 5ec80d2)
...
PR 병합 후 09/T2 스트림을 연다 (`ai-stream.sh open 09/T2 kakao-cookie-login`).