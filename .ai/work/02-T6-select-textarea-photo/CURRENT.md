...
- Task: 02/T6
- Issue: none
- Touches: src/ui/Select.tsx, src/ui/TextArea.tsx, src/ui/PhotoUpload.tsx
- Supersedes: none
- Acked: none
...
`docs/phases/02-design-system/PLAN.md`에서 02/T6의 Done when·Acceptance Criteria를 확인하고 HANDOFF의 Goal·Work In Progress를 쓴 뒤 시작한다.
