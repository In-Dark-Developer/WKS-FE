# Current State — chore-dating-rank-label

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-dating-rank-label
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-dating-rank-label
- Task: -/-
- Issue: none
...
- [x] 1. 순위→관계 유형 문구 고정(`relationLabelByRank`), 뷰 모델에서 relationLabel 제거
- [x] 2. 테스트·preview 가짜 데이터 갱신, test/typecheck/lint 통과
...
- `src/features/dating/recommendation/cardsView.ts:relationLabelByRank`
- `src/features/dating/recommendation/CandidateCard.tsx:CandidateCard`
