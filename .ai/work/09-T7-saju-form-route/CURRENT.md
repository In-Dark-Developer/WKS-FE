# Current State — 09-T7-saju-form-route

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: 09-T7-saju-form-route
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/09-T7-saju-form-route
- Task: 09/T7
- Issue: none
- Touches: src/features/intro/, src/app/routes/, src/app/screens/, src/features/dating/index.ts, src/ui/assets/teaser/, docs/prd/20-screens.md, docs/prd/30-functional-requirements.md, docs/ARCHITECTURE.md
- Supersedes: 09-T7-teaser-every-visit
...
- 1. `/` 티저 전용, 사주 입력 `/saju` 분리, 티저 지남 기록 제거, PRD·ARCHITECTURE (완료)
