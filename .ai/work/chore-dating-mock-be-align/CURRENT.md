...
- [x] 1. 카드 뷰 모델: 잠긴 사진 thumbnailUrl nullable, mbti 필수
- [x] 2. preview·테스트 가짜 데이터를 추천 응답 값으로
- [x] 3. 전화번호 규칙을 BE PHONE_PATTERN 과 같게
...
- `src/features/dating/recommendation/cardsView.ts:CandidatePhoto`
- `src/features/dating/card/CandidateFaces.tsx:CandidatePhotoLayer`
- `src/features/dating/profile/profileSchema.ts:contactError`

## Next Action

`scripts/ai-end.sh --ready` 로 PR.
