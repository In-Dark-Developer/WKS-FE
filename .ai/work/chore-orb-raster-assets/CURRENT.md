# Current State — chore-orb-raster-assets

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-orb-raster-assets
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-orb-raster-assets
- Task: -/-
- Issue: none
- Touches: src/ui/assets/orbs/,src/features/friends/map/tiers.ts
- Supersedes: none
...
- 1. 구슬·배지 SVG 8종을 3배 PNG 로 (commit 1d4702e) → PR ←
...
- `src/features/friends/map/tiers.ts:tierLooks` · `src/ui/assets/orbs/*.png`
