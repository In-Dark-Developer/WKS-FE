# Current State — chore-share-text-title

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-share-text-title
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-share-text-title
- Task: -/-
- Issue: none
- Touches: src/features/share/link/shareLink.ts,src/features/share/link/shareLink.test.ts
- Supersedes: none
...
- 1. 공유 title 을 text 첫 줄로 (commit fed638a) → PR ←
...
PR CI 통과 → merge → 카카오톡으로 공유해 세 줄로 보이는지 확인
