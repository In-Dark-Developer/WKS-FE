# Current State — spec-cookie-auth-sync

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: spec-cookie-auth-sync
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/spec-cookie-auth-sync
- Task: -/-
- Issue: none
...
- 1. openapi 쿠키 계약을 BE #91 실제 값으로 맞춤 (완료)
...
병합 후 dev.threadoffate.site 에서 09/T2·T3·T8 실제 모드 확인.
