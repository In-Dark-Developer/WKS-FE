...
- Task: 11/T2
- Issue: none
- Touches: src/features/dating/, src/app/routes/
- Supersedes: none
- Acked: none
...
`docs/phases/11-dating-thread/PLAN.md`에서 11/T2의 Done when·Acceptance Criteria를 확인하고 HANDOFF의 Goal·Work In Progress를 쓴 뒤 시작한다.
