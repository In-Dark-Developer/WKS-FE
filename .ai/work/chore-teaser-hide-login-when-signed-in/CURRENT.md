# Current State — chore-teaser-hide-login-when-signed-in

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-teaser-hide-login-when-signed-in
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-teaser-hide-login-when-signed-in
- Task: -/-
- Issue: none
- Touches: src/features/intro/MainTeaser.tsx,src/app/routes/saju.routes.tsx,src/app/routes/index.test.tsx,src/app/App.test.tsx
- Supersedes: none
...
chore: teaser-hide-login-when-signed-in
...
- [x] 티저 index loader(GET /me)로 로그인 여부, 로그인이면 '이미 아이디가 있어요' 숨김 (6906230)
...
- `src/app/routes/saju.routes.tsx:mainTeaserLoader`
- `src/features/intro/MainTeaser.tsx`
