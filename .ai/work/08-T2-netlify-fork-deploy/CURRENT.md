# Current State — 08-T2-netlify-fork-deploy

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: 08-T2-netlify-fork-deploy
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/08-T2-netlify-fork-deploy
- Task: 08/T2
- Issue: none
- Touches: netlify.toml, .github/workflows/, docs/deploy/, docs/decisions/, docs/ARCHITECTURE.md, docs/api/openapi.yaml, docs/phases/08-launch-readiness/, docs/phases/README.md, .ai/team/announcements/, .ai/team/README.md
...
- 1. netlify.toml 복원, sync-fork.yml, AWS 워크플로우·문서 삭제
- 2. ADR·ARCHITECTURE·openapi·PLAN·공지·운영 문서
...
PR 병합(소유자) → PAT·Secret·Variable 등록 → sync-fork 수동 실행 → 08/T3
