# Current State — chore-og-image-swap

<!-- 50줄 이내. Status: TODO | IN_PROGRESS | BLOCKED | REVIEW (DONE은 병합 여부로 도출). Progress는 step마다, 나머지는 세션 종료 시 갱신. 머리의 필드는 ai-stream.sh가 채운다. -->

- Stream: chore-og-image-swap
- Owner: 98745092+jjjung0921@users.noreply.github.com
- Branch: ws/chore-og-image-swap
- Task: -/-
- Issue: none
- Touches: index.html,public/og/og.jpg,src/ui/assets/og.png
- Supersedes: none
...
- 1. 소유자 교체 `og.png`(1200×630) → `public/og/og.jpg` 재생성, `og:image:height` 630 (commit 4c0de0c)
...
PR 병합(fork 소유자) → 카카오 공유 디버거 캐시 초기화 후 확인
