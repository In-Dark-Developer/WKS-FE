...
- 인연카드 앞면은 수치(0–100 바)가 아니라 문자 등급(SS·S·A+·A·B+·B) — 디자인 갱신 필요 (2026-09-13 기획 피드백, PRD FR-5·Q7)
