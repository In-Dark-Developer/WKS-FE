...
| [`20-screens.md`](20-screens.md) | Screens(SCR-01~22) 표 · V1 흐름 · 공유 링크 흐름 | 화면·라우트를 정할 때 |
| [`30-functional-requirements.md`](30-functional-requirements.md) | FR-1~31 | 구현·리뷰 기준을 볼 때 |
...
**번호 읽는 법** — FR-1~FR-18 · NFR-1~NFR-6 · SC-1~SC-6 은 V0.5(축제 운영본)이고, FR-19~FR-31 ·
