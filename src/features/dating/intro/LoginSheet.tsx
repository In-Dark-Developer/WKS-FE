...
export function LoginSheet({ open, onClose, onKakaoLogin }: Props) {
  return (
    <BottomSheet
    ...
    >
      ...
      <div className="flex flex-col items-center gap-16">
        <div className="flex flex-col items-center text-center text-primary">
          <h2 className="text-ui-20 font-bold">내 운명 찾아 떠나기</h2>
          <p className="text-ui-14">간편하게 로그인 후 내 반쪽을 찾으러 가요!</p>
        </div>
